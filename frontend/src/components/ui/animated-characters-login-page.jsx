...
function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Store token and user data in localStorage for authenticated requests
      if (data.token) {
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            <h1 className="text-4xl font-extrabold tracking-tight mb-2">
              <span className="text-blue-900 dark:text-blue-800">C</span>ampus
              <span className="text-blue-900 dark:text-blue-800">C</span>ore
            </h1>
            <h2 className="text-3xl font-bold tracking-tight mb-2 mt-4">Welcome back!</h2>
